...
class CpuLoad final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:monitor.proto.CpuLoad) */ {
 public:
  inline CpuLoad() : CpuLoad(nullptr) {}
  ~CpuLoad() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR CpuLoad(::google::protobuf::internal::ConstantInitialized);
